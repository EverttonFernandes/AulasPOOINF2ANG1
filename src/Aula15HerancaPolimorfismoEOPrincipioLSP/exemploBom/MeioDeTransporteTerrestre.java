...
public abstract class MeioDeTransporteTerrestre {
    ...
    protected MeioDeTransporteTerrestre(int velocidadeMaxima, String placa, boolean temCombustivel, String marca, String modelo) {
